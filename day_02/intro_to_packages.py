...
real_num = random.randint(-10, 10)
imag_num = random.randint(-10, 10)
...
guess_real = int(input("Guess"))
guess_imag = int(input("Guess"))

while guess_real != target_real and guess_imag != target_imag:
    if guess_real > target_real or guess_imag > target_imag:
        print("Too high!")
    if guess_real < target_real or guess_imag < target_imag:
        print("Too low!")
    guess_real = int(input("Guess 1: "))
    guess_imag = int(input("Guess 2: "))
print(f"Correct! The complex number is {target}")
